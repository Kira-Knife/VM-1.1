...
type HeatmapToday struct {
	...
	CountAlerts    int64     `json:"count_alerts"`    // число алертов в диапазоне от BeginTime до EndTime
	CountIncidents int64     `json:"count_incidents"` // число инцидентов в диапазоне от BeginTime до EndTime
